...
const techStack = [
  ...
  {
    langImage:"assets/images/techstack-page/blogger.png",
    langName:"Blogger",
    langDesc:"<li>Blogger is a blog-publishing service that allows multi-user blogs with time-stamped entries.</li>"
  },
];
